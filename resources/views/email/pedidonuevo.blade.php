...
<body>
    ...
    <div style="background:#131b4d;font-family:Verdana,Arial,Helvetica,sans-serif;font-size:12px;margin:0;padding:0">
                    ...
                    <td align="center" valign="top" style="padding:20px 0 20px 0">
                        <table bgcolor="#FFFFFF" cellspacing="0" cellpadding="10" border="0" width="650" style="border:1px solid #131b4d">
                            <tbody>
                                    ...
                                    <td valign="top" style="padding:20px">
                                        ...
                                        <p style="font-size:12px;line-height:16px;margin:0">
                                            <span style="font-size:14px;line-height:20px">Si tienes alguna duda respecto a su pedido, ponte en contacto con nosotros enviando un
                                                ...
                                                <a href="mailto:info@craftimes.com.pe" style="color:#c16a10"
                                                   target="_blank">info@craftimes.com.pe</a>, por el chat online o Whatsapp a
                                                <span class="m_768238685266715055nobr">(+51) 992249926</span>.
                                            </span>
                                        </p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding:20px">
                                        <table cellspacing="0" cellpadding="0" border="0" width="650">
                                            <thead>
                                                <tr>
                                                    <th align="left" width="325" bgcolor="#EAEAEA" style="font-size:12px;color:#131b4d;padding:7px 9px 8px 9px;line-height:1em">Información de facturación:</th>
                                                    <th width="10"></th>
                                                    <th align="left" width="325" bgcolor="#EAEAEA" style="font-size:12px;color:#131b4d;padding:7px 9px 8px 9px;line-height:1em">Método de pago:</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            <tr>
                                        ...
                                        <table cellspacing="0" cellpadding="0" border="0" width="650">
                                            <thead>
                                            <tr>
                                                <th align="left" width="325" bgcolor="#EAEAEA" style="font-size:12px;color:#131b4d;padding:7px 9px 8px 9px;line-height:1em">Información de envío:</th>
                                                <th width="10"></th>
                                                <th align="left" width="325" bgcolor="#EAEAEA" style="font-size:12px;color:#131b4d;padding:7px 9px 8px 9px;line-height:1em">Método de envío:</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <tr>
                                        ...
                                        <table cellspacing="0" cellpadding="0" border="0" width="650" style="border:1px solid #eaeaea">
                                            ...
                                            @foreach ($pedido->detalles as $detalle)
                                                <tr>
                                                    ...
                                                    <td align="right" valign="top" style="font-size:11px;padding:3px 9px;border-bottom:1px dotted #cccccc">
                                                        <span class="m_768238685266715055price">S/{{ $detalle->precio_unitario }}</span>
                                                    </td>
                                                    <td align="right" valign="top" style="font-size:11px;padding:3px 9px;border-bottom:1px dotted #cccccc">
                                                        <span class="m_768238685266715055price">S/{{ $detalle->total }}</span>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            </tbody>
                                            ...
                                            <tbody>
                                                <tr class="m_768238685266715055subtotal">
                                                    <td colspan="4" align="right" style="padding:3px 9px">Total</td>
                                                    <td align="right" style="padding:3px 9px">
                                                        <span class="m_768238685266715055price">S/{{ $pedido->precio }}</span>
                                                    </td>
                                                </tr>
                                                <tr class="m_768238685266715055shipping">
                                                    <td colspan="4" align="right" style="padding:3px 9px">Costo de envío </td>
                                                    <td align="right" style="padding:3px 9px">
                                                        <span class="m_768238685266715055price">S/0</span>
                                                    </td>
                                                </tr>
                                                <tr class="m_768238685266715055grand_total">
                                ...
                                <tr>
                                    <td bgcolor="#c16a10" align="center" style="background:#c16a10;text-align:center;padding:12px">
                                        <center>
