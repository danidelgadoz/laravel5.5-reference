                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td valign="top" style="padding:20px">
                                        <h1 style="font-size:22px;color:#131b4d;font-weight:normal;line-height:22px;margin:0 0 11px 0">Bienvenido {{ $suscripcion['nombres'] }},</h1>
                                        ...
                                        <p style="font-size:12px;line-height:16px;margin:0">
                                            ...
                                            <span style="font-size:14px;line-height:20px">
                                                ...
                                                PM en la dirección que has ingresado: {{ $suscripcion['direccion'] }} - {{ $suscripcion['distrito'] }}
                                            </span>
                                        </p>
                                    </td>
                                </tr>
