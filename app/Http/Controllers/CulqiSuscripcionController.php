...
class CulqiSuscripcionController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        if($request->estado) {
            if($request->estado == 'ALL')
                $suscripciones = CulqiSuscripcion::all();
            else
                $suscripciones = CulqiSuscripcion::where('estado', $request->estado)->get();
        } else {
            $suscripciones = CulqiSuscripcion::all();
        }
    ...
    public function store(Request $request)
    {
        ...
        $suscripcion = DB::transaction(function () use ($request) {
            ...
            $suscripcion = new CulqiSuscripcion();
     ...
     *
     * @param  \App\CulqiSuscripcion  $suscripcion
     * @return \Illuminate\Http\Response
     */
    public function show(CulqiSuscripcion $suscripcion)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(CulqiSuscripcion $suscripcion)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, CulqiSuscripcion $suscripcion)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(CulqiSuscripcion $suscripcion)
    {
        //
    }

    public function confirm(Request $request, CulqiSuscripcion $suscripcion)
    {
    ...
    public function cancel(Request $request, CulqiSuscripcion $suscripcion)
    {
    ...
    {
        $suscripciones = CulqiSuscripcion::all()->map(function ($item) {
